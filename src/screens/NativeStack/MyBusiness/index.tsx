...
import {Colors, productColors} from '../../../resources/colors';
...
const MyBusiness = ({
  ...
  //     },
  //   ];
  //   setFilteredBusinessList(Array);
  //   setRandomHexCodeArray(generateRandomHexCode(Array.length));
  // }, []);
      ...
      <View style={styles.BottomContainer}>
        <FlashList
          ...
          renderItem={({item, index}) => {
            console.log(productColors[index]);
            return (
